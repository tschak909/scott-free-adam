...
cpmcp -f adam scott-adams-adventures-disk2.dsk dist2/adv6.dat 0:adv6.dat
...
cpmcp -f adam scott-adams-adventures-disk4.dsk dist4/adventur.com 0:adventur.com
